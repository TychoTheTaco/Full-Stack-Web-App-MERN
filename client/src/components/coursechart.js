...
// info is a json file
// loc is a jquery object containing a single div
// department_id = 1 or 2
export const generateChart = (info, loc, department_id) => {
    var nodes = [];
    var prereqs = [];
    var classHash = {};
    var type_ids = []
    ...
    .force("link",d3.forceLink().distance(function(link) {
    ...
    var classMouseOver = function(d) {
        ...
        var traverse = function(node) {
            console.log(node)
            //console.log(node.hasOwnProperty("srcElement"))
            if(node.srcElement != null) {
